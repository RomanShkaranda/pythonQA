...
# - якщо користувачу менше 7. Functions, comprehensions - вивести повідомлення"Де твої батьки?"
...
# - якщо вік користувача містить цифру 7. Functions, comprehensions - вивести повідомлення "Вам сьогодні пощастить!"
